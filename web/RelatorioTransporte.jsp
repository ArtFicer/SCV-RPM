...
<html>
    ...
    <body style="background-color:#e6ffe6">
        ...
        <div class="container" >
            ...
            <form data-toggle="validator" role="form" action="RelatorioTransporteController?acao=exibirRelatorio" method="post" name="frmRelatorioProposto" >
                <div class="form-group">
                    <label for="usr">Empresa (O preenchimento é opcional):</label>
                    <select class="selectpicker" id="pTransporte" name="pTransporte">
