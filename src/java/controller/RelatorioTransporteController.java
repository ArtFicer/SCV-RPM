...
public class RelatorioTransporteController extends HttpServlet {
    ...
    public void prepararRelatorio(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("/RelatorioTransporte.jsp");
    ...
    private void exibirRelatorio(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            String nomeRelatorio = "Transporte";
            String pTransporte = request.getParameter("pTransporte");
            HashMap parametros = new HashMap();
            String relatorio = null;

            if (pTransporte != null && !pTransporte.equals("")) {
                parametros.put("P_Transporte", pTransporte);
