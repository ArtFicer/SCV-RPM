...
public class ManterRelatorioViagemController extends HttpServlet {
    ...
    private void confirmarIncluir(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RelatorioViagemDAO.obterInstancia().gravar(relatorioViagem);
    ...
    public void prepararEditar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int codRelatorioViagem = Integer.parseInt(request.getParameter("txtCodRelatorioViagem"));
            RelatorioViagem relatorioViagem = RelatorioViagemDAO.obterInstancia().obterRelatorioViagem(codRelatorioViagem);
    ...
    private void confirmarEditar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RelatorioViagemDAO.obterInstancia().alterar(relatorioViagem);
    ...
    private void confirmarExcluir(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RelatorioViagemDAO.obterInstancia().excluir(relatorioViagem);
