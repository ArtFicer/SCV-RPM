...
public class RelatorioRelatorioViagemController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            if (!nomeRelatorio.equals("RelatorioViagem")) {
                nomeRelatorio = "RelatorioViagem";
            }
            if (!parametroBusca.equals("")) {
                parametros.put("P_Relatorio", parametroBusca);
