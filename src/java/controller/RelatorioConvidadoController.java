...
public class RelatorioConvidadoController extends HttpServlet {
    ...
    public void prepararRelatorio(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.setAttribute("convidados", ConvidadoDAO.obterInstancia().obterConvidados());
            RequestDispatcher view = request.getRequestDispatcher("/RelatorioConvidado.jsp");
    ...
    private void exibirRelatorio(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException, JRException {

        Connection conexao = null;
        try {
            conexao = BD.getConexao();
            String nomeRelatorio = "Convidado";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioConvidadoController.class.getName()).log(Level.SEVERE, null, ex);
