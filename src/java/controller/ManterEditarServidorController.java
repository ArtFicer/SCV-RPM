 ...
 * @author pe-ri
 */
@WebServlet(name = "ManterEditarServidorController", urlPatterns = {"/ManterEditarServidorController"})
public class ManterEditarServidorController extends HttpServlet {
...
@Override
        ...
        try {
            ...
            Logger.getLogger(ManterEditarServidorController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
