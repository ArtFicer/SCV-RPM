...
<html>
    <head>
        ...
        <title>Relatórios de Transporte</title>
    </head>
    <body style="background-color:#e6ffe6">
        ...
        <div class="container" >
            ...
            <form data-toggle="validator" role="form" action="RelatorioTransporteController" method="post" name="frmRelatorioProposto" >
                <div class="form-group row-fluid"  >
                    <label for="usr" class="col-sm-2 col-form-label" >Nome do Relatório:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Ex: Transporte" id="usr" name="nomeRelatorio">
                    </div>
                </div>
                <div class="form-group row-fluid" >
                    <label for="usr" class="col-sm-2 col-form-label " >Parâmetro de Busca:</label>
                    <div class="col-sm-10" >
                        <input type="text" class="form-control" placeholder="Ex: Fulana" id="usr" name="parametroBusca">
                    </div>
                </div>
                <button type="submit" class="btn btn-default" name="btnRelatorio" value="Exibir">Exibir Relatório</button> 
                <button class="btn btn-default" ><a href="PesquisaTransporteController" target="_parent">Voltar</a></button>   
            </form>
        </div>        
    </body>
</html>
